...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2018/03/23 09:42:24 by lmatvien          #+#    #+#              #
#    Updated: 2018/04/04 17:46:26 by lmatvien         ###   ########.fr        #
#                                                                              #
#******************************************************************************#
...
SRC =	./ft_isalpha.c ./ft_memchr.c ./ft_strcat.c ./ft_strlcat.c ./ft_strnstr.c \
		...
		./ft_lstdel.c ./ft_lstadd.c ./ft_lstiter.c ./ft_lstmap.c ./ft_strnlen.c ./ft_count_words.c ./ft_strsplit_to_list.c \
		./ft_strlist.c ./ft_sqrt.c \
...
OBJ =	ft_isalpha.o ft_memchr.o ft_strcat.o ft_strlcat.o ft_strnstr.o \
		...
		ft_lstdel.o ft_lstadd.o ft_lstiter.o ft_lstmap.o ./ft_strnlen.o ./ft_count_words.o ./ft_strsplit_to_list.o \
		./ft_strlist.o ./ft_sqrt.o \
